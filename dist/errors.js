...
export class BfxApiError extends Error {
    ...
    /** Raw response body */
    response;
    constructor(message, status, statusText, code, response) {
        super(message);
...
export class RateLimitError extends BfxApiError {
    ...
    retryAfterMs;
    constructor(message, status, statusText, retryAfterMs = 60_000, response) {
...
export class NotFoundError extends BfxApiError {
    constructor(message, statusText = 'Not Found', response) {
 ...
 */
export function createApiError(message, status, statusText, code, response) {
